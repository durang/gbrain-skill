...
| OpenClaw 4.24-betas | Plugin runtime deps install loop | Cualquiera en betas | Quedarse en `2026.4.23` stable |
| OpenClaw + DeepSeek | `reasoning_content must be passed back` | DeepSeek-Reasoner / V4-Pro / V4-Flash | Usar MiniMax-M2.7 hasta fix |
...
|---|---|---|
| OpenClaw | `2026.4.23` (latest stable) | 4.24-betas tienen plugin loop |
...
3. DeepSeek thinking — provider rechaza schema sin reasoning_content handler
